...
<section id="newstudy_form">
    ...
    <form action="BookshareController" method="post">
        ...
        <input type="text" name="bookName" value="<c:out value='${ad.bookName}' />" required /><br>
        <label>Subject *</label>
        ...
        <label>URL *</label>
        <input type="text" name="url" value="<c:out value='${ad.url}' />" required/><br>
        <%-- Img tag is used to import image --%>
        <label>Image *</label>
        <input type="text" name="image" value="<c:out value='${ad.image}' />" required /><br>
        <label>Price *</label>  
        <input type="text" name="price" value="<c:out value='${ad.price}' />" required/><br>
        <label>Rent/Sell *</label> 
        <select name="rentOrSell" required>
            <option>Rent</option>
            <option>Sell</option>
        </select><br>
       <input type="submit" value="Update" id="search_button" />
    </form>
</section>
